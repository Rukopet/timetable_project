...
***Файл*** - (опционально) путь + имя файла по которому необходимо сохранить файл, без расширения; Если этот параметр не указывается файл сохраняется в data внутри пакета, с дефолтным именем

### Adminer для управлнеия базой данных
По http://localhost:8080/ развернут ***Adminer*** для управлнеия ***postgres***<br>
По умолчанию: <br>
 - Сервер по умолчанию **db**
 - **Имя бд** - postgres
 - **Имя пользователя** - postgres
 - **Пароль** - postgres

### Добваление модулей для алгоритма
Для вычисления пригодности расписания, используется фитнесс-функция, она в свою очередь использует модульный подход для вычисления. Уже сейчас можно добавить кастомный модуль за счет заложенной абстракции. <br>
#### Чтобы добавить кастомный модуль в алгоритм необходимо (Python):
- Начать писать класс модуля, отнаследоваться от базового класса [модуля](https://github.com/Rukopet/timetable_algorithm/blob/3746ee3142c02eb0b06403442b5b22c11bca5309/timetable_genetic_algorithm/fitness_modules/audience_specialization.py#L6)
- Перегрузить [метод](https://github.com/Rukopet/timetable_algorithm/blob/3746ee3142c02eb0b06403442b5b22c11bca5309/timetable_genetic_algorithm/fitness_modules/audience_specialization.py#L9), который будет возвращать приспособленность
- Зарегестрировать модуль через подуль [регистратор](https://github.com/Rukopet/timetable_algorithm/blob/3746ee3142c02eb0b06403442b5b22c11bca5309/timetable_genetic_algorithm/fitness_modules/audience_specialization.py#L5)
- Импортировать [модуль](https://github.com/Rukopet/timetable_algorithm/blob/3746ee3142c02eb0b06403442b5b22c11bca5309/timetable_genetic_algorithm/fitness_func/main_function.py#L10) в главном цикле
